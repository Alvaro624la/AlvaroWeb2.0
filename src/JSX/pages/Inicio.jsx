        ...
        <div className='inicio'>
            <header className='inicio__header'>
                ...
                <p style={{backgroundColor: '#FFDC0011', color: '#FFDC00'}}>
                    ⚠️ Esta página está en actual desarrollo. El apartado de blogs está actualmente falto y pobre en cuanto contenido se refiere. Poco a poco iré añadiendo funcionalidades y contenido más variado, como puede ser, aparte de HTML, CSS, JavaScript, React, Git, etc. ⚠️
                </p>
                <p>
